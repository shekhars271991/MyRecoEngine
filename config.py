...
DESCRIPTION_VECTOR_DIMENSION = 384
PRICE_VECTOR_DIMENSION = 1
RATING_VECTOR_DIMENSION = 1
STOCK_VECTOR_DIMENSION = 1
...
PRODUCT_PROFILE_VECTOR_DIMENSION = PLOT_VECTOR_DIMENSION + PRICE_VECTOR_DIMENSION + RATING_VECTOR_DIMENSION + STOCK_VECTOR_DIMENSION